...
export function HeroScene() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/15 bg-black/20 p-8">
      ...
      />
      <h1 className="text-4xl font-bold">Stella Match</h1>
      <p className="mt-4 max-w-2xl text-white/85">
        Meet Nova, a robotic cat-like mentor, guiding students through floating skill-orbs, magical tools, and
        real-time knowledge exchange.
      </p>
      <div className="mt-8 grid gap-3 sm:grid-cols-3">
        {['Skill Orb', 'Sword Tool', 'Mentor Beacon'].map((item) => (
